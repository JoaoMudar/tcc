...
const MAPA = {
  ...
  'RF-11': ['`containers`', 'Recipientes'],
  'RF-12': ['`inputs`', 'Insumos'],
  'RF-13': ['`areas`, `beds`', 'Áreas e canteiros'],
  'RF-14': ['`cadastro.parties`, `cadastro.party_roles`', 'Pessoas'],
  'RF-15': ['`cadastro.parties`', 'Pessoas'],
  'RF-16': ['`cadastro.parties`, `cadastro.addresses`', 'Dados fiscais de pessoa'],
  'RF-17': ['`cadastro.parties`', 'Dados fiscais de pessoa'],
  'RF-18': ['`cadastro.parties`, `cadastro.party_roles`', 'Pessoas'],
  'RF-19': ['`cadastro.parties`, `cadastro.party_roles`', 'Pessoas'],
  'RF-20': ['`cadastro.parties`, `cadastro.party_roles`', 'Pessoas'],
  'RF-21': ['`task_types`', 'Tipos de tarefa'],
  'RF-22': ['`protocols`, `protocol_steps`', 'Protocolo de atividades'],
  'RF-23': ['`protocol_steps`', 'Protocolo de atividades'],
  'RF-24': ['`protocol_steps`', 'Protocolo de atividades'],
  'RF-25': ['`species_protocol_overrides`', 'Protocolo de atividades'],
  'RF-26': ['*sem entidade*: organização de interface', 'Agenda da semana'],
  'RF-27': ['`week_plans`, `assignments`, `assignment_members`', 'Agenda da semana'],
  'RF-28': ['`assignments`', 'Agenda da semana'],
  'RF-29': ['`week_plans`', 'Agenda da semana'],
  'RF-30': ['`assignments`, `assignment_members`', 'Confirmação de tarefa'],
  'RF-31': ['`assignments`', 'Confirmação de tarefa'],
  'RF-32': ['`assignments`', 'Confirmação de tarefa'],
  'RF-33': ['`assignments`, `week_plans`', 'Fechamento da semana'],
  'RF-34': ['`batches`, `batch_movements`', 'Lotes'],
  'RF-35': ['`batches`, `beds`, `areas`', 'Lotes'],
  'RF-36': ['`batches`, `batch_movements`', 'Lotes'],
  'RF-37': ['`batch_movements`', 'Movimentos de lote'],
  'RF-38': ['`batches`, `batch_movements`', 'Movimentos de lote'],
  'RF-39': ['`batch_movements`', 'Movimentos de lote'],
  'RF-40': ['`batch_movements`', 'Perdas'],
  'RF-41': ['`batch_movements`', 'Movimentos de lote'],
  'RF-42': ['`batches`, `batch_protocol_steps`', 'Divisão de lote'],
  'RF-43': ['`batch_movements`', 'Análise de perdas'],
  'RF-44': ['*derivada* de `batch_movements` e `batches`', 'Análise de perdas'],
  'RF-45': ['*derivada*; limite em `settings`', 'Análise de perdas'],
  'RF-46': ['*derivada* de `batches`', 'Estoque disponível'],
  'RF-47': ['`batches`, `beds`, `areas`', 'Mapa de lotes'],
  'RF-48': ['visão `batch_health`', 'Mapa de lotes'],
  'RF-49': ['*derivada* de `batch_movements`', 'Mapa de lotes'],
  'RF-50': ['`batches`, `protocols`, `batch_protocol_steps`', 'Lotes'],
  'RF-51': ['`assignments`, `batch_protocol_steps`', 'Agenda da semana'],
  'RF-52': ['`batches`, `batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-53': ['`batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-54': ['`batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-55': ['`batch_protocol_steps`, visão `batch_protocol_due`', 'Protocolo de atividades'],
  'RF-56': ['visão `batch_protocol_due`', 'Protocolo de atividades'],
  'RF-57': ['`batch_protocol_steps`, `assignments`', 'Protocolo de atividades'],
  'RF-58': ['`orders`, `order_items`', 'Pedidos'],
  'RF-59': ['`order_items`', 'Pedidos'],
  'RF-60': ['*derivada* de `batches`', 'Estoque disponível'],
  'RF-61': ['`orders`', 'Confirmação de pedido'],
  'RF-62': ['`orders`', 'Pedidos'],
};
