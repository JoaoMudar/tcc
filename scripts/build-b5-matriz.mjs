...
const MAPA = {
  ...
  'RF-26': ['`week_plans`, `assignments`, `assignment_members`', 'Agenda da semana'],
  'RF-27': ['`assignments`', 'Agenda da semana'],
  'RF-28': ['`week_plans`', 'Agenda da semana'],
  'RF-29': ['`assignments`, `assignment_members`', 'Confirmação de tarefa'],
  'RF-30': ['`assignments`', 'Confirmação de tarefa'],
  'RF-31': ['`assignments`, `week_plans`', 'Fechamento da semana'],
  'RF-32': ['`batches`, `batch_movements`', 'Lotes'],
  'RF-33': ['`batches`, `beds`, `areas`', 'Lotes'],
  'RF-34': ['`batches`, `batch_movements`', 'Lotes'],
  'RF-35': ['`batch_movements`', 'Movimentos de lote'],
  'RF-36': ['`batches`, `batch_movements`', 'Movimentos de lote'],
  'RF-37': ['`batch_movements`', 'Movimentos de lote'],
  'RF-38': ['`batch_movements`', 'Perdas'],
  'RF-39': ['`batch_movements`', 'Movimentos de lote'],
  'RF-40': ['`batches`, `batch_protocol_steps`', 'Divisão de lote'],
  'RF-41': ['`batch_movements`', 'Análise de perdas'],
  'RF-42': ['*derivada* de `batch_movements` e `batches`; limite em `settings`', 'Análise de perdas; Mapa de lotes'],
  'RF-43': ['*derivada* de `batches`', 'Estoque disponível'],
  'RF-44': ['`batches`, `beds`, `areas`', 'Mapa de lotes'],
  'RF-45': ['visão `batch_health`', 'Mapa de lotes'],
  'RF-46': ['`batches`, `protocols`, `batch_protocol_steps`', 'Lotes'],
  'RF-47': ['`assignments`, `batch_protocol_steps`', 'Agenda da semana'],
  'RF-48': ['`batches`, `batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-49': ['`batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-50': ['`batch_protocol_steps`', 'Protocolo de atividades'],
  'RF-51': ['`batch_protocol_steps`, visão `batch_protocol_due`', 'Protocolo de atividades'],
  'RF-52': ['visão `batch_protocol_due`', 'Protocolo de atividades'],
  'RF-53': ['`batch_protocol_steps`, `assignments`', 'Protocolo de atividades'],
  'RF-54': ['`orders`, `order_items`', 'Pedidos'],
  'RF-55': ['`order_items`', 'Pedidos'],
  'RF-56': ['*derivada* de `batches`', 'Estoque disponível'],
  'RF-57': ['`orders`', 'Confirmação de pedido'],
  'RF-58': ['`orders`', 'Pedidos'],
};
