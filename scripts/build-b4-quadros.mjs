...
const NOME = {
  ...
  'RF-83': 'Manutenção do período de trabalho',
  'RF-139': 'Manutenção dos parâmetros de operação',
  'RF-08': 'Cadastro de espécie',
  'RF-09': 'Busca de espécie por qualquer nome',
  'RF-10': 'Cadastro de recipiente',
  'RF-11': 'Cadastro de insumo',
  'RF-80': 'Cadastro de área do viveiro',
  'RF-81': 'Cadastro de canteiro',
  'RF-140': 'Identidade única de pessoa com múltiplos papéis',
  'RF-36': 'Cadastro rápido de cliente',
  'RF-37': 'Cadastro completo de cliente',
  'RF-38': 'Validação de CPF e CNPJ',
  'RF-39': 'Busca de pessoa',
  'RF-52': 'Cadastro de fornecedor',
  'RF-69': 'Cadastro de funcionário',
  'RF-70': 'Catálogo de tipos de tarefa',
  'RF-82': 'Formulário comandado pelo tipo de tarefa',
  'RF-122': 'Protocolo de atividades por recipiente',
  'RF-123': 'Etapa do protocolo com agendamento e tempo',
  'RF-124': 'Evento de referência da etapa',
  'RF-125': 'Alerta e janela de aviso por etapa',
  'RF-133': 'Tempo de etapa customizado por espécie',
  'RF-108': 'Entrada da área Produção em duas abas',
  'RF-71': 'Montagem da agenda da semana',
  'RF-72': 'Cópia da semana e tarefa recorrente',
  'RF-73': 'Situação da semana',
  'RF-92': 'Tarefa com vários executores',
  'RF-107': 'Confirmação da tarefa realizada',
  'RF-98': 'Quantidade realizada por participante',
  'RF-99': 'Lote exigido na confirmação',
  'RF-113': 'Área ou canteiro da tarefa sem lote',
  'RF-75': 'Tarefa não confirmada assumida no fechamento',
  'RF-84': 'Criação de lote',
  'RF-85': 'Ocupação do viveiro por área e canteiro',
  'RF-86': 'Repicagem com lote de origem',
  'RF-87': 'Histórico de movimentos do lote',
  'RF-88': 'Recusa de saldo negativo',
  'RF-89': 'Encerramento do lote por saldo zero',
  'RF-91': 'Registro de perda, contagem e venda sobre o lote',
  'RF-26': 'Perda com causa em lista fechada',
  'RF-23': 'Contagem física do lote',
  'RF-135': 'Divisão de lote',
  'RF-27': 'Listagem de perdas com filtro',
  'RF-28': 'Cálculo da taxa de mortalidade',
  'RF-29': 'Alerta de mortalidade acima do limite',
  'RF-22': 'Quantidade de muda pronta disponível',
  'RF-117': 'Mapa do viveiro com áreas, canteiros e lotes',
  'RF-118': 'Classificação da situação do lote',
  'RF-119': 'Tarefa pendente e atraso do lote',
  'RF-120': 'Mortalidade destacada no mapa',
  'RF-126': 'Atribuição do protocolo ao lote na criação',
  'RF-127': 'Geração das ordens do protocolo na agenda',
  'RF-128': 'Avanço de fase por etapa sequencial',
  'RF-129': 'Contagem a partir da execução real',
  'RF-130': 'Uma ocorrência em aberto por etapa',
  'RF-131': 'Ficha do lote com etapas e vencimentos',
  'RF-132': 'Etapa em atenção e em atraso',
  'RF-134': 'Encerramento do protocolo do lote',
  'RF-41': 'Registro de pedido com cliente, canal e itens',
  'RF-141': 'Preço unitário informado no item',
  'RF-42': 'Saldo disponível ao lado do item',
  'RF-142': 'Situação do pedido',
  'RF-143': 'Listagem de pedidos com filtro',
};
