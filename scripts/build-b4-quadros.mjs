...
const NOME = {
  ...
  'RF-13': 'Cadastro de área do viveiro',
  ...
  'RF-21': 'Catálogo de tipos de tarefa',
  ...
  'RF-26': 'Entrada da área Produção em duas abas',
  'RF-27': 'Montagem da agenda da semana',
  'RF-28': 'Cópia da semana e tarefa recorrente',
  'RF-29': 'Situação da semana',
  'RF-34': 'Tarefa com vários executores',
  'RF-30': 'Confirmação da tarefa realizada',
  'RF-36': 'Quantidade realizada por participante',
  'RF-31': 'Lote exigido na confirmação',
  'RF-32': 'Área ou canteiro da tarefa sem lote',
  'RF-33': 'Tarefa não confirmada assumida no fechamento',
  'RF-34': 'Criação de lote',
  'RF-35': 'Ocupação do viveiro por área e canteiro',
  'RF-36': 'Repicagem com lote de origem',
  'RF-37': 'Histórico de movimentos do lote',
  'RF-38': 'Recusa de saldo negativo',
  'RF-45': 'Encerramento do lote por saldo zero',
  'RF-39': 'Registro de perda, contagem e venda sobre o lote',
  'RF-40': 'Perda com causa em lista fechada',
  'RF-41': 'Contagem física do lote',
  'RF-42': 'Divisão de lote',
  'RF-43': 'Listagem de perdas com filtro',
  'RF-44': 'Cálculo da taxa de mortalidade',
  'RF-45': 'Alerta de mortalidade acima do limite',
  'RF-46': 'Quantidade de muda pronta disponível',
  'RF-47': 'Mapa do viveiro com áreas, canteiros e lotes',
  'RF-48': 'Classificação da situação do lote',
  'RF-56': 'Tarefa pendente e atraso do lote',
  'RF-49': 'Mortalidade destacada no mapa',
  'RF-50': 'Atribuição do protocolo ao lote na criação',
  'RF-51': 'Geração das ordens do protocolo na agenda',
  'RF-52': 'Avanço de fase por etapa sequencial',
  'RF-53': 'Contagem a partir da execução real',
  'RF-54': 'Uma ocorrência em aberto por etapa',
  'RF-55': 'Ficha do lote com etapas e vencimentos',
  'RF-56': 'Etapa em atenção e em atraso',
  'RF-57': 'Encerramento do protocolo do lote',
  'RF-58': 'Registro de pedido com cliente, canal e itens',
  'RF-59': 'Preço unitário informado no item',
  'RF-60': 'Saldo disponível ao lado do item',
  'RF-61': 'Situação do pedido',
  'RF-62': 'Listagem de pedidos com filtro',
};
