...
CREATE TABLE batches (
  ...
  -- (RF-50). Nulo enquanto `protocols` nao existir, e tambem quando o recipiente
...
-- RF-46: o saldo disponivel e a soma dos lotes PRONTOS daquela especie e
...
CREATE TABLE batch_movements (
  ...
  -- por causa, que e para o que RF-43 existe.
  loss_cause        TEXT,
...
-- RF-43, RF-44: a analise de perdas filtra por periodo e causa, e a mortalidade
