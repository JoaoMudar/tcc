...
| É quantitativa por unidade? | quando sim, o encerramento pede **quanto cada participante fez**; quando não, não pede número algum (RF-30) |
| Lote específico? | quando sim, o encerramento exige o lote, que traz consigo canteiro, espécie e recipiente (RF-31) |
