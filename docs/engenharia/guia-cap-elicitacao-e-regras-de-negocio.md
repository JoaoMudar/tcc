...
> Para quem: você, sentando para escrever, sem tempo de reler as linhas de documentação.
...
3. **Regras de negócio** já estão catalogadas: 54 regras em
...
| `A1` | §8 (Premissas e §9) Restrições | As 7 restrições **RE-1 a RE-7**: cada uma é um achado de elicitação (usuários sem formação técnica, conexão instável, mãos sujas, base financeira misturada) |
...
| 5. Restrições identificadas | `A1` §9 (RE-1 a RE-7) | Não |
...
> [`B3-regras-de-negocio.md`](B-requisitos/B3-regras-de-negocio.md): **54 regras**, cada uma com
...
| B: Produção, lote e trabalho | RN-08 a RN-31 | 24 | Saldo derivado dos lotes, contagem física prevalece, causa da perda em lista fechada, mortalidade, lote e canteiro, planejamento por turno, semana que fecha, quantidade por pessoa |
| C: Protocolo de atividades por lote | RN-32 a RN-43 | 12 | Protocolo do recipiente, âncora declarada, contagem da execução real, uma ocorrência em aberto, alteração que não retroage |
| D: Cliente e pedido | RN-44 a RN-52 | 9 | PF/PJ, cadastro mínimo, identidade única com papéis, canal de venda, nota em sistema externo, preço negociado |
| E: Acesso e responsabilidade | RN-53, RN-54 | 2 | Perfil determina o acesso; todo registro tem autor |
...
| 2. Regras de domínio e produto | Área A |
| 3. Regras de produção, lote e trabalho | Área B: é a **espinha dorsal do trabalho**, e onde os objetivos OP-2 e OP-3 se apoiam |
| 4. Regras do protocolo de atividades | Área C: o único conjunto que descreve comportamento automático |
| 5. Regras de cliente e pedido | Área D |
| 6. Regras de acesso e responsabilidade | Área E |
...
1. Crie o artefato-fonte que falta em `docs/engenharia/`, seguindo a convenção de códigos:
   ...
   - `B-requisitos/B3-regras-de-negocio.md`: **✅ já existe**, com as 54 regras e as tabelas de vínculo
