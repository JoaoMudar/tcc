...
3. **Regras de negócio** já estão catalogadas: 52 regras em
...
> [`B3-regras-de-negocio.md`](B-requisitos/B3-regras-de-negocio.md): **52 regras**, cada uma com
...
## 2.2 O catálogo: 52 regras, em [`B3`](B-requisitos/B3-regras-de-negocio.md)
...
| E: Acesso e responsabilidade | RN-51, RN-52 | 2 | Perfil determina o acesso; todo registro tem autor |
...
1. Crie o artefato-fonte que falta em `docs/engenharia/`, seguindo a convenção de códigos:
   ...
   - `B-requisitos/B3-regras-de-negocio.md`: **✅ já existe**, com as 52 regras e as tabelas de vínculo
