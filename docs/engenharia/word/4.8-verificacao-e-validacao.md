...
> Gerado a partir de `F-ux/F3-plano-avaliacao-usabilidade.md`.
> **Não edite este arquivo**: edite o artefato de origem e rode `node scripts/build-word.mjs`.

## 4.8.1 O que este documento resolve

O §4.8.3.6 da metodologia promete avaliar a usabilidade segundo os cinco atributos de Nielsen, com
...
## 4.8.3 Os cinco atributos operacionalizados
...
## 4.8.8 Relação com os requisitos e com os testes de aceite
