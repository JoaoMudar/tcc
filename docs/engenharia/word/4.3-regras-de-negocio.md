...
## 4.3.1 Como usar este documento
...
### 4.3.2.1 O que é e o que não é regra de negócio
...
### 4.3.2.3.1 O critério de granularidade
...
derivado não se digita" **falha no teste da §4.3.2.1**: apague o sistema e não há onde digitar. É
...
### 4.3.2.4 Quatro regras que são convenção, não fato observado
...
## 4.3.3 Catálogo de regras de negócio

### 4.3.3.1 Área A: Domínio e produto
...
### 4.3.3.2 Área B: Produção, lote e trabalho
...
### 4.3.3.3 Área C: Protocolo de atividades por lote
...
### 4.3.3.4 Área D: Cliente e pedido
...
### 4.3.3.5 Área E: Acesso e responsabilidade
...
## 4.3.4 Rastreabilidade inversa: requisito funcional → regra que o origina
...
| RF-61 | RN-56, RN-57 |
| RF-62 | RN-58 |
## 4.3.5 Rastreabilidade inversa: requisito não funcional → origem
...
## 4.3.6 Requisitos que não decorrem de regra de negócio

### 4.3.6.1 Requisitos funcionais sem regra de negócio
...
### 4.3.6.2 As restrições que originam os requisitos não funcionais
...
### 4.3.6.3 Regras sem requisito que as realize por inteiro
...
## 4.3.7 Apêndice: texto integral dos requisitos
...
### 4.3.7.2 Requisitos não funcionais
