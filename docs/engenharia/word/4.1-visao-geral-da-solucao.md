...
> Gerado a partir de `A-fundacao/A1-documento-de-visao.md`.
...
## 4.1.6 Escopo: o que o sistema fará
...
## 4.1.7 Escopo: o que o sistema **não** fará
...
| **Tela de campo** | Os seis colaboradores não operam o sistema: o trabalho deles é planejado e confirmado pela gerência. Ver §4.1.5. |
...
## 4.1.11 Visão do produto em uma frase
