...
![Figura 5: Modelo conceitual: visão geral](img/4.5-modelagem-de-dados-fig05.png)

**Figura 5**: Modelo conceitual: visão geral. Fonte: elaborado pelo autor (2026).
...
![Figura 6: Acesso e configurações: transversal às três áreas](img/4.5-modelagem-de-dados-fig06.png)

**Figura 6**: Acesso e configurações: transversal às três áreas. Fonte: elaborado pelo autor (2026).
...
![Figura 7: Área 1 · Cadastro único](img/4.5-modelagem-de-dados-fig07.png)

**Figura 7**: Área 1 · Cadastro único. Fonte: elaborado pelo autor (2026).
...
![Figura 8: Área 2 · Produção](img/4.5-modelagem-de-dados-fig08.png)

**Figura 8**: Área 2 · Produção. Fonte: elaborado pelo autor (2026).
...
![Figura 9: Área 3 · Comercial](img/4.5-modelagem-de-dados-fig09.png)

**Figura 9**: Área 3 · Comercial. Fonte: elaborado pelo autor (2026).
