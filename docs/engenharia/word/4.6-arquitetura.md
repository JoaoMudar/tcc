...
## 4.6.1 As três camadas antes dos diagramas
...
## 4.6.4 Nível 3: Componentes da camada de lógica
...
## 4.6.5 Decisões arquiteturais e suas consequências
...
## 4.6.6 Atendimento aos requisitos não funcionais
...
## 4.6.10 Publicação e migração de esquema
...
## 4.6.11 Distribuição, proteção e o compromisso entre as duas
...
## 4.6.12 Segurança na fronteira entre nós
