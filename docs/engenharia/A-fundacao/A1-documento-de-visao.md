...
| **Apuração de custo e formação de preço** | O preço é o que foi negociado na conversa com o cliente (RN-52). Apurar custo exigiria medir consumo de insumo e tempo por lote, e nenhum dos dois é registrado hoje: o sistema calcularia sobre dado que não tem. |
...
> 20 % (RN-11) perde o poder de apontar **qual leva** morreu. Sem lote a repicagem é uma soma que
...
| **RE-2** | Celular como dispositivo principal | Contexto de campo | Concepção orientada ao uso móvel, não adaptação de tela de computador. Vale para o **registro em campo**; as duas telas de coordenação da produção são exceção declarada, sob RNF-14 |
