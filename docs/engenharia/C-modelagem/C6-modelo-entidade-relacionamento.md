...
erDiagram
  ...
  RECIPIENTE   }o--|| TIPO_EMBALAGEM : "é do tipo"
  TIPO_EMBALAGEM ||--o| PROTOCOLO    : "define"
  ...
  ETAPA_PROTOCOLO ||--o{ PRODUCAO  : "gera ordem de"
...
erDiagram
  ...
  batch_protocol_steps {
    ...
    uuid inherited_from_batch_id FK
  }
  batch_protocol_due {
    uuid batch_id
    uuid step_id
