# Acréscimos ao Capítulo 2.5 do TCC

> **Não é artefato de engenharia.** É texto de referencial teórico, exigido pelos artefatos
> [`E5`](E5-mapeamento-lgpd.md) e [`E6`](E6-plano-backup-recuperacao.md): ambos apresentam
> resultados no Capítulo 4 que o Capítulo 2 atual não fundamenta.
>
> Redigido em prosa acadêmica, pronto para colar. Três parágrafos e duas referências novas.
