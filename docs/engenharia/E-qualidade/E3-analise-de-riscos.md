# E3: Análise de riscos do projeto

> **Artefato:** Análise de riscos · **Bloco:** E, Qualidade, riscos e segurança
> **Destino no TCC:** **Capítulo 3 (Metodologia)**, não Capítulo 4. Análise de riscos do projeto é
> elemento metodológico, não resultado.
> **Fundamentação:** Pressman e Maxim (2016) tratam a gestão de riscos como atividade contínua do
> processo de software, organizada em identificação, projeção (probabilidade e impacto), avaliação
> e planejamento de mitigação.
